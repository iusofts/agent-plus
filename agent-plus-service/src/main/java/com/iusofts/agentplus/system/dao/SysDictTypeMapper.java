...
import com.iusofts.agentplus.system.entity.SysDictType;
...
public interface SysDictTypeMapper extends BaseMapper<SysDictType> {
     ...
     * @return 字典类型集合信息
     */
    public List<SysDictTypeDto> selectDictTypeList(IPage page, @Param("param") SysDictTypeDto dictType);
     ...
     * @return 结果
     */
    public SysDictTypeDto checkDictTypeUnique(String dictType);
}
