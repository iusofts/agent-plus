...
public class TestController extends BApiController {
    ...
    @PostMapping("/test")
    public TestVO test(@YzValidated @RequestBody TestVO param) {
        return param;
    }
